import {getAreaData,getAreaDataByCode,getGoodsData,getGoodsDataDetail,getKeyCompanyData,getKeyCompanyDataSum,getKeyCompanyDataByCode} from '@/api/manageStatistics'
