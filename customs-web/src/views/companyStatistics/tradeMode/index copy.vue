<template>
    ...
    <div class="customsData-container scroll-y p">
        ...
        <el-tab-pane label="贸易方式统计" name="first" >
            <el-container >
                <el-card style="width: 150%;">
                    <el-header>进口贸易方式统计</el-header>
...
const handleTabChange = () =>{
    switch(activeName._rawValue){
        case "first":getImportCustomsData();break;
        case "first":getImportCustomsData();break;
    }
}
...
const initPickEAndGetTradeMode = () => {
    const end = new Date();
    const start = new Date(new Date().getFullYear(), 0);
