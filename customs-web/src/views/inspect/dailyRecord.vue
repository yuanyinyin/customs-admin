...
<!--    <div class="head-container m-1 mr-3 rowSS">
    ...
    <el-card class="m-1">
      ...
      >
        ...
        <el-table-column prop="patrolTime" label="巡检日期" align="center"/>
    ...
    <dialog-daily :dialog-daily="dialogData"></dialog-daily>
  </div>
</template>
...
import {listPage} from "@/api/dailyRecord";
import {Ref} from "vue";
import DialogDaily from '@/views/inspect/dialogDaily.vue'
