<template>
  <div>
    <!-- <iframe src="/ycj/big/big_pc.html" style="width:100%;height:100%;" frameborder="0" allowFullScreen = "true" ref="fIframe"></iframe> -->
  </div>
</template>
...
const fIframe = ref<any>();
  ...
  onMounted(() => {
    ...
    window.open("/ycj/big/big_pc.html?token="+getToken());
  })
