...
<div>
    <el-dialog v-model="tablemodel"  :titleName=titleName
    width="75%" 
    align-center>
    <el-table :data="tableDataE"  fit
                border
                height="500px"
                highlight-current-row>
      <el-table-column type="index" label="序号" align="center" width="55"/>
      <el-table-column property="CODETS" label="商品编号" width="105"/>  
      <el-table-column property="GNAME" label="商品名称" />
      <el-table-column property="CIQNAME" label="检验检疫名称" />
      <el-table-column property="CONTRITEM" label="备案序号" />
      <el-table-column property="GMODEL" label="规格型号" show-overflow-tooltip/>
      <el-table-column property="ORIGINCOUNTRY_VALUE" label="原产国" />
      <el-table-column property="DESTINATIONCOUNTRY_VALUE" label="目的国" />
      <el-table-column property="GQTY" label="数量" />
      <el-table-column property="DECLPRICE" label="单价" />
      <el-table-column property="TRADECURR_VALUE" label="币制" width="55" />
      <el-table-column property="RMB" label="人民币总价" />
      <el-table-column property="DUTYMODE_VALUE" label="征免" />
    </el-table>
</el-dialog>
</div>
</template>
...
import { getGoodsData } from '@/api/manageStatistics'
