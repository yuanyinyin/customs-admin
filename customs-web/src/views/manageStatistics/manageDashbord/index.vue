              ...
              <el-row :gutter="15">
                <el-col :md="24" :lg="12">
                  <div class="data-item">
                    ...
                    <div class="stati">
                      <span class="number blue">{{ liveness.activeEnterprise.amount || 0 }}</span><span
                      class="unit">家</span>
                    </div>
                    <div class="ratio" v-if="showflag">
                      同比
                      <span v-if="liveness.activeEnterprise.proportion >= 0"
                            class="green">↑ {{ liveness.activeEnterprise.proportion || 0 }}%</span>
                ...
                <el-col :md="24" :lg="12">
                  <div class="data-item">
                    ...
                    <div class="stati">
                      <span class="number red">{{ liveness.keyEnterprise.molecule || 0 }}/</span><span
                      class="denominator">{{ liveness.keyEnterprise.denominator || 0 }}</span>
                    </div>
                    <div class="ratio" v-if="showflag">
                      同比
                      <span v-if="liveness.keyEnterprise.proportion >= 0"
                            class="green">↑ {{ liveness.keyEnterprise.proportion || 0 }}%</span>
            ...
            <el-card class="card-item" :body-style="{padding:'5px 15px 15px',height:'100%'}">
              ...
              <el-row :gutter="15">
                ...
                <el-col :md="24" :lg="12">
                  <div class="rg-box">
                    <div class="rg-item">
                      <pie-chart summary="汇总" unit="单" :colors="['#DE6BFF','#FFD26F']" title="单量" :list="listOne"
                                 v-show="flagTotalCustomDataSum"/>
                    </div>
                    <div class="rg-item">
                      <pie-chart summary="汇总" unit="单" :colors="['#DE6BFF','#FFD26F']" title="货值" :list="listTwo"
                                 v-show="flagTotalCustomDataNumb"/>
                    </div>
                  </div>
                </el-col>
              </el-row>
...
import PieChart from '../../companyStatistics/components/PieChart/index';
