...
public class NoticeController {
    ...
    public ApiResponse update(@PathVariable String id,UserEntity user,@RequestBody String jsonString){
    ...
    @GetMapping("/listPageDashBoard")
    public ApiResponse listPageDashBoard(@RequestParam Map<String, String> params, UserEntity user) {
        return noticeService.listPageDashBoard(params, user);
    }
}
